        ...
        <div className="flex flex-col items-center gap-3 pt-4 pb-8">
          ...
          <div className="flex gap-3 mt-2 flex-wrap justify-center">
            {alreadyReviewed
              ...
              : <button onClick={rateAlbum} className="px-5 py-2.5 rounded-xl font-semibold text-[13px] cursor-pointer text-white" style={{ background: 'linear-gradient(135deg, #B14EFF, #FF3FA4)' }}>Rate it</button>}
